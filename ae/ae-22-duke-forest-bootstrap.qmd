...
-   Which confidence level produces the most accurate confidence interval (90%, 95%, 99%)?
    ...
    The 99% interval is most accurate in the sense of higher confidence that it actually contains the true value.

-   Which confidence level produces the most precise confidence interval (90%, 95%, 99%)?
    Explain
    
    The 90% interval is most precise in the sense of being more specific about where the true value might live.
...
-   If we want to be very certain that we capture the population parameter, should we use a wider or a narrower interval?
    ...
    You want a wider interval, but a wider interval is less informative. If all you cared about was an interval that contained the truth with high confidence, then you could just say $(-\infty,\,\infty)$. The truth is guaranteed to be in there, but that interval is not at all informative about where the true value is likely to be.
