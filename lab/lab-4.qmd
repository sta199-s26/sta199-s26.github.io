...
description: "Due: End of lab on Thurs, Feb 5"
categories: Lab
filters:
  - ../remove-fmt-skip.lua
draft: false
...
What does the error message mean and why does it occur? How would you fix the code? Supply the proposed fix and re-run the code chunk.
