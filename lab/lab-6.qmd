...
description: "Due: End of lab on Thurs, March 19"
categories: Lab
filters:
  - ../remove-fmt-skip.lua
draft: false
...
Your goal is to "make up" the outcome variable `y` such that when you fit a linear regression model predicting `y` from `x`, the following are true about the model:
