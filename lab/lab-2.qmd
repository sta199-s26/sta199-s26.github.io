---
title: Lab 2
subtitle: Continued Exploration of NC Counties
...
This lab is designed to increase your comfort with the course computing workflow.
One of the main goals of this lab is to reinforce our demo of R and RStudio, which we will be using throughout the course to learn the statistical concepts discussed in the course, analyze real data, and make informed conclusions about said data.
...
::: render-commit-push
Render, commit, and push your changes to GitHub with the commit message "Added answer for Q1, parts b & c".
