...
The next two questions rely on work you did back on [HW 4](/hw/hw-4.html#gapminder), where the `gapminder` dataframe is read in and transformed into `gapminder23`. This dataframe can be re-created with the code below:
...
e.  Based on the false positive and false negatives rates of this model, comment, in 1-2 sentences, on which model (one from Question 8 or Question 9) is preferable and why.
