...
-   **palmerpenguins** and **datasauRus** packages for some datasets (MTK: need to sort out where palmerpenguins is loaded) -- also edit this in hw-4 template file
...
## Questions 6-7 (MTK: do we want to add more questions to part 1, if not -- need to redo these question numbers)
...
MTK: could get rid of datasaurus and have entire assignment be 5 questions (join quarto into one quesiton). get AI and human feedback on all of it?
