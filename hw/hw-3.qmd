...
-   the region the state belongs to, and

-   the sales tax rate (`combined_tax_rate`).
...
The resulting data frame should contain 3 variables: the state name, the region the state belongs to, and the `combined_tax_rate`.
