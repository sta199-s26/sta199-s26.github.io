...
::: callout-note
Answer are [here](/exams/midterm-2-answers.html).
:::
...
i. Consider this bt of toy code: `linear_reg() |> fit(_BLANK_, df)`? What goes in the blank? What purpose does that argument serve, and how do you use it?
