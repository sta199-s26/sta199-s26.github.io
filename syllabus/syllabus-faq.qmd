...
## How do I code along with the code alongs?

Here is a repo that has all of the files and data for you to follow along with the "Code along" videos:

<https://github.com/sta199/code-alongs>

You can [clone](https://sta199-s26.github.io/lab/lab-0.html#babys-first-repo) a copy of this repo into your container, but you will not be able to *push* your changes back. So it's just a sandbox for you to make a low-stakes mess.
