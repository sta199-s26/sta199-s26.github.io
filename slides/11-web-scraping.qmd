...
Because the data are already formatted as an honest-to-goodness table, you *can* successfully highlight the whole table with your cursor, copy it, paste it into an empty Excel spreadsheet, and then clean it by hand. BUT:
