...
If all of your conversations with {ChatGPT, Gemini, Claude, etc} were suddenly made public, how would you feel?
...
::: {.column width="45%"}
![](images/14/duke-symphony.png)
:::

::: {.column width="55%"}
- Duke Symphony;
- 7:30 PM in Baldwin Auditorium (East Campus);
- Featuring fifteen JZ students (and counting!).
:::


:::

## Also tonight! {.scrollable}

7 PM in Biological Sciences 113:

![](images/14/alumni-panel.jpg)


## Reminders

::: incremental
- Tonight: Make progress on your project (clean, plot, summarize);
    - Everyone should commit!
- Thursday lab: continue to work and give another team feedback;
    - If absent, it's on you to coordinate with your group;
- By Friday: complete midsemester check-in;
    - It's an anonymous Canvas quiz;
