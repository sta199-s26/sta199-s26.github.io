...
:::::: columns
:::: {.column width="50%"}
![](images/21/momentum.png)
::::

::: {.column width="50%"}

- Insta: [@momentum_duke](https://www.instagram.com/momentum_duke/)
- Friday April 10 @ 7pm
- Reynolds Theatre
- Lily! Katarina! 
...
:::::: columns
:::: {.column width="45%"}
![](images/21/nakisai.jpeg)
::::

::: {.column width="55%"}

- Insta: [@dukenakisaiade](https://www.instagram.com/dukenakisaiade/)
- Saturday April 11 @ 7pm
- Page Auditorium
- #DOMOREBELIT
...
:::::: columns
:::: {.column width="40%"}
![](images/21/pureun.png)
::::

::: {.column width="60%"}

- Insta: [@duke_pureun](https://www.instagram.com/duke_pureun/)
