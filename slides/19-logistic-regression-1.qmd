...
- These later peer evals get by far the most weight in assessing your the 10% of your project grade devoted to "Teamwork;"
- Make sure you are thorough and honest.
...
If we add one exclamation mark to the model, we predict the odds of an email being spam to be **higher** by a multiplicative factor of $e^{0.000272}\approx 1.000272$ on average.
