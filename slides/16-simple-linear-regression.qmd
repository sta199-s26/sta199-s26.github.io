...
- The lowercase roman letters denote estimated values based on a finite, imperfect sample. These are out best guess at the true values based on the data we have.
...
- It *does* make sense to predict audience score if the critics gave it a 0%.
:::
