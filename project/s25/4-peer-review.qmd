...
#| message: false
#| eval: true
teams <- read_sheet("https://docs.google.com/spreadsheets/d/16r5FvyJHWm2QBRJEredFB_f_l_JIolzOZGLkfmy92Bg", sheet = paste0("lab_", 1))
...
#| message: false
#| eval: true
teams <- read_sheet("https://docs.google.com/spreadsheets/d/16r5FvyJHWm2QBRJEredFB_f_l_JIolzOZGLkfmy92Bg", sheet = paste0("lab_", 2))
make_pairing_table(teams)
```
...
#| message: false
#| eval: true
teams <- read_sheet("https://docs.google.com/spreadsheets/d/16r5FvyJHWm2QBRJEredFB_f_l_JIolzOZGLkfmy92Bg", sheet = paste0("lab_", 3))
make_pairing_table(teams)
```
...
#| message: false
#| eval: true
teams <- read_sheet("https://docs.google.com/spreadsheets/d/16r5FvyJHWm2QBRJEredFB_f_l_JIolzOZGLkfmy92Bg", sheet = paste0("lab_", 4))
make_pairing_table(teams)
```
...
#| message: false
#| eval: true
teams <- read_sheet("https://docs.google.com/spreadsheets/d/16r5FvyJHWm2QBRJEredFB_f_l_JIolzOZGLkfmy92Bg", sheet = paste0("lab_", 5))
make_pairing_table(teams)
```
...
#| message: false
#| eval: true
teams <- read_sheet("https://docs.google.com/spreadsheets/d/16r5FvyJHWm2QBRJEredFB_f_l_JIolzOZGLkfmy92Bg", sheet = paste0("lab_", 6))
make_pairing_table(teams)
```
...
#| message: false
#| eval: true
teams <- read_sheet("https://docs.google.com/spreadsheets/d/16r5FvyJHWm2QBRJEredFB_f_l_JIolzOZGLkfmy92Bg", sheet = paste0("lab_", 7))
make_pairing_table(teams)
```
...
#| message: false
#| eval: true
teams <- read_sheet("https://docs.google.com/spreadsheets/d/16r5FvyJHWm2QBRJEredFB_f_l_JIolzOZGLkfmy92Bg", sheet = paste0("lab_", 8))
make_pairing_table(teams)
```
...
#| message: false
#| eval: true
teams <- read_sheet("https://docs.google.com/spreadsheets/d/16r5FvyJHWm2QBRJEredFB_f_l_JIolzOZGLkfmy92Bg", sheet = paste0("lab_", 9))
make_pairing_table(teams)
```
...
#| message: false
#| eval: true
teams <- read_sheet("https://docs.google.com/spreadsheets/d/16r5FvyJHWm2QBRJEredFB_f_l_JIolzOZGLkfmy92Bg", sheet = paste0("lab_", 10))
make_pairing_table(teams)
```
:::
