...
The six milestones for the final project are
...
## Milestone 3 - Improvement + progress: proposal to project {#improvement-progress}

Instructions and grading criteria for this milestone are outlined in [Milestone 3: Improvement + progress: proposal to project](/project/3-improvement-progress.html).
...
Instructions and grading criteria for this milestone are outlined in [Milestone 5: Write-up + presentation](/project/5-writeup-presentation.html).
